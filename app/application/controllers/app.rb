...
# for checking if the episode info is viewed, then do not show progress bar
        ...
        routing.on String, String do |type, id|
          ...
          routing.get do
            ...
            if type == 'episode'
              ...
              elsif episode_info.response.processing?
                if episode_info.response.processing? && EpisodeInfoAccessors.check.zero?
